...
class DemoListViewController: UIViewController {
    ...
    private var itemDefs = [ItemDef(title: "Line Chart",
                    ...
                    ItemDef(title: "Line Chart (Range Separators)",
                            subtitle: "Demonstration of the linechart with range separators.",
                            class: LineChartRangeSeparatorsViewController.self),
